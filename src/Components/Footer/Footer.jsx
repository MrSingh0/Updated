...
export default function Footer() {
  return (
    <section class="foot py-10 sm:pt-16 lg:pt-24">
      <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
          ...
          <h1 className='logo w-1/4 flex justify-start text-4xl'>FOBHA</h1>
            ...
            <ul class="flex items-center space-x-3 mt-9">
              <li>
                <a href="#" title="" class="flex items-center justify-center text-white transition-all duration-200 rounded-full w-7 h-7 hover:bg-blue-600 focus:bg-blue-600">
        ...
        <p class="text-sm text-center text-gray-600">© Copyright 2021, All Rights Reserved by FOBHA</p>
      </div>
    </section>
