    ...
    <div className='w-full text-black'>
      ...
      <div className='pl-16 pr-16'>
        ...
        <div className='flex w-full'>
          ...
          <img src={about} alt="" className='w-3/4  rounded-xl h-56 text-left mb-3' />
        </div>
